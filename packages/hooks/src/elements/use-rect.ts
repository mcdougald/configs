 ...
 * @param action.rect
 */
function rectReducer(state: { height: any; width: any }, action: { rect: any }) {
 ...
 * @param nodeRef
 * @param nodeRef.current
 * @param initialRect
 */
export function useRect(nodeRef: { current: any }, initialRect = { width: 0, height: 0 }) {
