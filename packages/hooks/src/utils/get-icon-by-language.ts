'use client'
import { SiJavascript, SiMarkdown, SiMdx, SiReact, SiTypescript } from '@icons-pack/react-simple-icons'
...
export const getIconByLanguage = (language: string): FC<SVGProps<SVGSVGElement>> => {
